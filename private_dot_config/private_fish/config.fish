...
function bootstrap_scratch_worktree -a main_worktree_path
    cp $main_worktree_path/priv/repo/seeds_local.exs ./priv/repo
    cp $main_worktree_path/.envrc .
    cp $main_worktree_path/.tool-versions .
    direnv allow
    asdf install
    make dev_build
end
